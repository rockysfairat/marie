    ...
    <html lang="en">
      ...
      <body className="w-full sm:pt-[60px] flex flex-col items-center pt-[30px]">
        <AppContext.Provider value={{ englishVersion, setEnglishVersion }}>
          <h1 className=" w-full px-4 xl:px-24 uppercase font-semibold text-3xl sm:text-2xl md:text-2xl">
            marie.does.design
          </h1>
          {/* Hamburger menu */}
          <div
            className="hamburgerMenu cursor-pointer absolute right-0 top-2 p-5 flex flex-col  z-50 bg-neutral-950 sm:hidden md:hidden"
            onClick={toggleMenu}
          >
